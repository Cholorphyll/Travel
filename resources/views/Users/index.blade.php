          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Users 
                <a href="{{route('add_user')}}" target="_blank" class="btn btn-info ml-3"><strong>Add New User</strong></a> 
                  ...
                  <div class="col-md-12 mt-3">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3 mt-4">
                        <button type="submit" class="btn btn-outline-secondary" id="search_users">Search</button>
                      </div>
                    </div>
                    <!-- </form>  -->
                  </div>
