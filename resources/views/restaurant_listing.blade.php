...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/public/css/restaurant.css')}}">
        ...
        <div class="collapse navbar-collapse " id="collapsibleNavId">
            ...
            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                <li class="nav-item active">
                    <a class="nav-link" href="#"> <img src="{{asset('public/images/Frame 61.svg')}}" alt="" class=""></a>
                </li>
            </ul>
        </div>
    </nav>
			...
			@if(!empty($getsight))
                <div class="card mb-50 card-img-scale border-0 overflow-hidden bg-transparent">
                    ...
                    <div class="card-img-scale-wrapper rounded-3">
                        ...
                        <!-- Image -->
                        <img src="{{asset('public/images/unsplash_7T1KOFfE1aM.png')}}" class="card-img br-10 mb-12" alt="hotel image">
...
if (marker) {
  marker.setIcon(
    L.icon({
      iconUrl: '{{asset('public/images/red-location.png')}}', // Replace with the path to your red icon image
...
if (marker) {
  marker.setIcon(
    L.icon({
      iconUrl: '{{asset('public/js/images/marker-icon.png')}}', // Replace with the path to your highlighted icon image
