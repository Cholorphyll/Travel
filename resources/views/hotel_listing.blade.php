  ...
  <div class="hotel-listing-page">
    ...
    [2,3,5,7,8,5,3,2,3,6,5,4,7,5,4,3,2]
                  ...
                  <div class="row d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-6">
                      <button class="orangebutton" onclick="fetchFilteres_without_date()">
                        Apply
                      </button>
                    </div>
                  </div>
                  ...
                  <div class="row mnts">
                    <div class="col-md-6">
                      ...
                      <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" value="Breakfast included" id="flexCheckDefault"
                          name="mnt">
      ...
      <div>
        <span class="d-none loc_id"> {{$locationId}} </span>
        <span class="d-none " id="slugid"> {{$slgid}} </span>
        <span id="Tplocid" class="d-none">{{$locationId}}</span>
        <span class="d-none lname"> {{$lname}} </span>
        <span class="d-none countryname"> {{$countryname}} </span>
        ...
        <span class="d-none withoutdate">withoutdate</span>
            ...
            <div class="col-md-4">
              <div class="card-slider">
                  ...
                  <div class="hotel-listing-slider slick-initialized slick-slider" style="overflow: hidden; width: 100%; height: 100%;">
                      ...
                      <img src="https://s3-us-west-2.amazonaws.com/s3-travell/hotel-images/{{$searchresult->id}}.jpg" alt="" style="width: 100%; height: auto; border-radius: 10px;">
                      @else
                      <img src="https://photo.hotellook.com/image_v2/limit/h{{ $searchresult->hotelid }}_1/400/231.jpg" alt="" style="width: 100%; height: auto; border-radius: 10px;">
                      @endif
                  </div>
              </div>
          </div>
            ...
            <div class="col-md-5">
              <div class="py-3 px-2 border-toend">
                ...
                <?php    $ctName = $lname;
                          ...
                          ?>
                <span class="d-none "><a
                    href="{{ url('hd-'.$slgid.'-' .$searchresult->id .'-'.strtolower( str_replace(' ', '_',  str_replace('#', '!',$searchresult->slug) )) ) }}"
                    target="_blank">{{$searchresult->name}}</a></span>
                <div class="fs20 fs-sm-14 fw-500  mb-2 hotel-title"><a
                    href="{{ url('hd-'.$slgid.'-' .$searchresult->id .'-'.strtolower( str_replace(' ', '_',  str_replace('#', '!',$searchresult->slug) )) ) }}"
                    target="_blank"> {{$searchresult->name}}</a></div>
                ...
                <p>@if($searchresult->about != "") {{$searchresult->about}} @endif</p>
              </div>
            </div>
        ...
        <div class="col-md-6" id="faqdata">
          <div class="asked-questions py-4">
            ...
            @elseif(Str::startsWith($value->Question, "What are the top cheap hotels in ") ||
            Str::startsWith($value->Question, "What are the best hotels in $lname with outdoor pools?"))
