                          ...
                          <div class="margin-l" style='margin-left: 39px;'>
                            ...
                            <div class="col-md-8 form-group">
                              ...
                              <p class="mt-3">
                                ...
                                <span class="margin-l" ><button class="btn btn-secondary on-site-restaurants margin-top">{{$rating}} Star</button><i class="fa fa-trash ml-3" ></i></span>
                              ...
                              <span class="Amenities margin-l mt-3">                                 
                                  @if(isset($getlanding[0]->Amenities) && $getlanding[0]->Amenities !== "null") 
                                      <?php 
                                          $HotelAmenities = json_decode($getlanding[0]->Amenities);
                                      ?>
                                        @foreach($HotelAmenities as $HotelAmenities)
                                        <span class="margin-l"><button class="btn btn-secondary on-site-restaurants margin-top">{{$HotelAmenities}}</button><i class="fa fa-trash ml-3" ></i></span>
