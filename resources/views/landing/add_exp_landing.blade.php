          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Add Experience Landing Page</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Add Experience Landing Page</h2>
              </div>  
            </div>
          </div>
        </div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-12">
                 ...
                 @if($get_landing->isEmpty())
                    <div class="row">
                      <div class="col-xs-8 col-sm-8 col-md-8">
                        <div class="form-group mb-3">
                          ...
                          <div class="col-md-8 form-group">
                            <div class="form-search form-search-icon-right">
                              ...
                              <input type="text" name="search_value" id="name" class="form-control rounded-3"
                                ...
                                <p class="errorname" style="color: red; display: none;">Name is Required.</p>
                              ...
                              <input type="text" name="search_value" id="slug"
                                ...
                                <p class="errorslug" style="color: red; display: none;">Slug is Required.</p>
                          ...
                          <input type="radio" id="Experience" name="page_type" value="Experience" class="margin-left" checked>
                          ...
                          <div class="margin-l" style='margin-left: 39px;'>
                            ...
                            <div class="col-md-8 form-group">
                              ...
                              <p class="mt-3">
                                ...
                                <span class="Languages_value margin-l mt-3"></span>
                              </p>
                              <p class="mt-3">
                                <span class="mt-3"><strong>Mobile Ticket:</strong></span>
                                <span class="Mobile_Ticket_value margin-l mt-3"></span>
                              </p>
                              <p class="mt-3">
                                <span class="mt-3"><strong>Experience Tags:</strong></span>
                                <span class="Experience_Tags_val margin-l mt-3"></span>
                              </p>                           
                          ...
                          <button type="button" id="add_exp_landing" data-id="" class="btn btn-outline-dark ">Create
                            Page</button>
                    ...
                    @else
                      <p>Landing page already added</p>
