          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Manage Faq</li>
              </ul>
            </div>
            <div class="col-md-12">
                        ...
                        <div id="attractionBox" class="searchBox">
                          ...
                          <div class="row m-3">
                            ...
                            <div class="col-md-3 mt-4">
                              <button type="submit" class="btn btn-outline-secondary " id="search_faq_attraction" data-type="attraction"
                               >Search</button>
                            </div>
                          </div>
                        </div>
                        <div id="hotelBox" class="searchBox" style="display: none;">
                        <h5 class="">Hotel Faq</h5>
                          <div class="row m-3">
                            <div class="col-md-3 form-group">
                            ...
                            <div class="col-md-3 mt-4">
                              <button type="submit" class="btn btn-outline-secondary search-faq-hotel"
                              data-type="hotel">Search</button>
                            </div>
                          </div>
                        </div>
                        <div id="restaurentBox" class="searchBox" style="display: none;">
                        <h5 class="">Restaurant Faq</h5>
                          <div class="row m-3">
                            <div class="col-md-3 form-group">
                              <strong class="form-label">Search Restaurant Name, Id or Url </strong>
                              <div class="form-search form-search-icon-right">
                                <input type="text" name="search_value" id=""
                                  class="form-control rounded-3 rest_input"  placeholder="Search restaurant"
                                  required><i class="ti ti-search"></i>
                              </div>
                            </div>
                            <div class="col-md-3 mt-4">
                              <button type="submit" class="btn btn-outline-secondary search-faq-restaurent"
                              data-type="restaurant" >Search</button>
                            </div>
                          </div>
                        </div>
                        <div id="experienceBox" class="searchBox" style="display: none;">
                        <h5 class="">Experience Faq</h5>
                        <div class="row">
                          <div class="col-md-3 form-group">
                          ...
                          <div class="col-md-3 mt-4">
                            <button type="submit" class="btn btn-outline-secondary search-faq-experience" data-type="experience"
                           >Search</button>
                          </div>
                          </div>
                        </div>
