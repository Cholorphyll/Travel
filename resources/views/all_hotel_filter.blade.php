...
;" />
            ...
            <div class="col-md-5">
              <div class="py-3 px-2 border-toend">
                ...
                <?php  
                                          $ctName = $sresult->cityName;
                                          $cityname = str_replace(' ', '_', $ctName);
                                          $CountryName = str_replace(' ', '_', $sresult->countryName);
              ...
              <div class="w-100 px-5 px-md-0">
                <div class="price">
                  ...
                  <div class="d-flex align-items-center justify-content-between p-api">
                    <img src="{{ 'http://pics.avs.io/hl_gates/100/40/' . $data['agencyId'] . '.png' }}"
                      alt="Agency Logo">
                ...
                <!-- Rest of the records -->
                <div class="d-flex align-items-center justify-content-between p-api">
                  <img src="{{ 'http://pics.avs.io/hl_gates/100/40/' . $data['agencyId'] . '.png' }}" alt="Agency Logo">
                  <div class="d-flex align-items-center">
