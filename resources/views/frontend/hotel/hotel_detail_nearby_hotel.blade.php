...
<div class="tr-nearby-hotel-list">
  <div class="tr-hotel-img">
    <a href="javascript:void(0):">
      ...
      <img loading="lazy" src="https://photo.hotellook.com/image_v2/limit/h{{$nearbhotel->hotel_id}}_1/376/229.jpg"
        alt="NearBy Hotel">
      @else
      <img loading="lazy" src="{{asset('public/images/Hotel lobby.svg')}}" alt="NearBy Hotel">
      @endif
    </a>
  </div>
