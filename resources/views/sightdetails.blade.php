  ...
  <main class="main ">
       ...
       <li class="breadcrumb-item active" aria-current="page">
          <a href="{{ route('explore_continent_list',[$breadcumb[0]->contid,$breadcumb[0]->ccName])}}" target="_blank"> {{$breadcumb[0]->ccName}}</a>
			...
			<li class="breadcrumb-item">
				<a
				   href="{{ route('explore_country_list',[$breadcumb[0]->CountryId,$breadcumb[0]->cslug])}}" target="_blank">
          ...
          <li class="breadcrumb-item active" aria-current="page">
            <a
              href="{{ route('search.results',[$searchresult[0]->slugid.'-'.strtolower($searchresult[0]->Lslug)]) }}" target="_blank"><span>{{$searchresult[0]->Name}}</span>
            </a>
          </li>
    ...
    <div class="container">
      ...
      <div class="row">
		...
		<div class="b-10 border border-3 border-c mb-4 bg-e text-center py-5 attraction-image" style="width: 100%; margin: 0 auto; overflow: hidden; position: relative; height: 600px;">
   <img src="{{ asset('public/sight-images/'. $Sight_image[0]->Image) }}" alt="" style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); max-width: none; max-height: none;" />
</div>
		 ...
		 <table>
            ...
            <!-- Card END -->
              ...
              <!-- end nearby  -->
         	  <!-- start nearby  -->
             <div class="nearby py-lg-5 py-4 border-top">
                <h5 class="mb-4  fs-22">Top ways to experience {{$searchresult[0]->Title}}</h5>      
                <div class="row " id="nearby_hotel">
                  ...
                  @foreach($get_experience as $get_experiences)
                    ...
                    <div class="col-md-6  ">
						...
						<div class="card card-img-scale border-0 overflow-hidden bg-transparent">
						  <!-- Image and overlay -->
						  <div class="card-img-scale-wrapper rounded-3">
							  @if($get_experiences->viator_url != "")
						 <a href="{{$get_experiences->viator_url}}"
								class=" text-decoration-none fs18 " taget="_blank">
							 @endif
              ...
              <div class="row overflow-borderradius position-relative">
                ...
                <div class="col-lg-6 ">
                  @if($get_experiences->Img1 !="")
                  <img src="{{$get_experiences->Img1}}" class="h-100 p1" alt="hotel image">
                  @else
                ...
                <div class="col-lg-6 d-none d-md-inline-block">
                  ...
                  <div class="row">
                    ...
                    <div class=" p1">
                      @if($get_experiences->Img2 !="")
                      <img src="{{$get_experiences->Img2}}" alt="hotel image">
                      @else
                    ...
                    <div class=" p1">
                      @if($get_experiences->Img3 !="")
                      <!-- <img src="{{ asset('public/images/image 3.png') }}" alt=""> -->
                      <img src="{{$get_experiences->Img3}}" alt="hotel image" style="width: 251px;">
                      @else
                      <img src="{{asset('public/images/Hotel lobby.svg')}}" alt="hotel image"
                        style="width: 251px;">
                      @endif
						  ...
						  <div class="">
							...
							<div class="d-flex align-items-center justify-content-between">
							  <a href="{{route('experince',[$get_experiences->slugid.'-'.$get_experiences->ExperienceId.'-'.$get_experiences->Slug])}}"
								class="text-decoration-none fs18 " target="_blank"><b>{{$get_experiences->Name}}</b></a>
							</div>
							  <div class="d-flex justify-content-between align-items-start locationandothers">
           					      <p class="mb-3">From  <b style="font-size: 15px;">{{ $get_experiences->Cost }}</b></p>
							</div>
							<div class="d-flex justify-content-between align-items-start locationandothers">

							  <p class="mb-3">Duration <b style="font-size: 15px;">{{ $get_experiences->Duration }}</b></p>
