                        ...
                        <div id="attractionBox" class="searchBox">
                          ...
                          <div class="row m-3">
                            ...
                            <div class="col-md-3 mt-4">
                              <button type="submit" class="btn btn-outline-secondary " id="search_r_attraction" data-type="attraction"
                               >Search</button>
                            </div>
                          </div>
                        </div>
                        <div id="hotelBox" class="searchBox" style="display: none;">
                        <h5 class="">Hotel Review</h5>
                          <div class="row m-3">
                            <div class="col-md-3 form-group">
                            ...
                            <div class="col-md-3 mt-4">
                              <button type="submit" class="btn btn-outline-secondary search-r-hotel"
                              data-type="hotel">Search</button>
                            </div>
                          </div>
                        </div>
                        <div id="restaurentBox" class="searchBox" style="display: none;">
                        <h5 class="">Restaurant Review</h5>
                          <div class="row m-3">
                            <div class="col-md-3 form-group">
                            ...
                            <div class="col-md-3 mt-4">
                              <button type="submit" class="btn btn-outline-secondary search-r-restaurent"
                              data-type="restaurant" >Search</button>
                            </div>
                          </div>
                        </div>
                        <div id="experienceBox" class="searchBox" style="display: none;">
                        <h5 class="">Experience Review</h5>
                        <div class="row">
                          <div class="col-md-3 form-group">
                          ...
                          <div class="col-md-3 mt-4">
                            <button type="submit" class="btn btn-outline-secondary search-r-experience" data-type="experience"
                           >Search</button>
                          </div>
                          </div>
                        </div>
