...
</svg><div style=""><span style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden;color: #4A4A4A;font-size: 14px;font-weight: 400;">{{ $searchresult['value'] }}</span></div></li>
    @endforeach
@else
    <p>Location not found</p>
    <li class="add_manually">+add Manually</li>
@endif
