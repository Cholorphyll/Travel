...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('/public/resources/css/app.css')}}"/>
        <script href="{{ asset('/public/resources/css/app.js')}}" ></script>
  <!-- [Favicon] icon -->
          ...
          <div class="card-body">
            <div class="d-flex align-items-center">
              <div class="flex-shrink-0">
                <img src="{{asset('/public/assets/images/user/avatar-1.jpg')}}" alt="user-image"
              ...
              <div class="dropdown-body">
                <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
                  <div class="d-flex mb-1">
                    <div class="flex-shrink-0">
                      <img src="{{asset('/public/assets/images/user/avatar-1.jpg')}}" alt="user-image" class="user-avtar wid-35" />
                    </div>
                    <div class="flex-grow-1 ms-3">
    ...
    <div class="offcanvas-body">
      ...
      <div class="card mb-3">
        <div class="card-body">
          ...
          <img src="{{asset('/public/assets/imageslayout/img-announcement-1.png')}}" alt="img" class="img-fluid mb-3" />
          <div class="row">
            <div class="col-12">
      ...
      <div class="card mb-3">
        <div class="card-body">
          ...
          <a href="https://1.envato.market/c/1289604/275988/4415?subId1=phoenixcoded&u=https%3A%2F%2Fthemeforest.net%2Fitem%2Fable-pro-responsive-bootstrap-4-admin-template%2F19300403"
            target="_blank"><img src="{{asset('/public/assets/imageslayout/img-announcement-2.png')}}" alt="img" class="img-fluid" /></a>
        </div>
      </div>
              ...
              <div class="col-6">
                <div class="d-grid">
                  <button class="preset-btn btn active" data-value="true" onclick="layout_caption_change('true');">
                    <img src="{{asset('/public/assets/imagescustomizer/img-caption-1.svg')}}" alt="img" class="img-fluid" width="70%" />
                  </button>
                </div>
              </div>
              <div class="col-6">
                <div class="d-grid">
                  <button class="preset-btn btn" data-value="false" onclick="layout_caption_change('false');">
                    <img src="{{asset('/public/assets/imagescustomizer/img-caption-2.svg')}}" alt="img" class="img-fluid" width="70%" />
                  </button>
                </div>
              </div>
            </div>
                ...
                <div class="col-6">
                  <div class="d-grid">
                    <button class="preset-btn btn active" data-value="false" onclick="layout_rtl_change('false');">
                      <img src="{{asset('/public/assets/imagescustomizer/img-layout-1.svg')}}" alt="img" class="img-fluid" width="70%" />
                    </button>
                  </div>
                </div>
                <div class="col-6">
                  <div class="d-grid">
                    <button class="preset-btn btn" data-value="true" onclick="layout_rtl_change('true');">
                      <img src="{{asset('/public/assets/imagescustomizer/img-layout-2.svg')}}" alt="img" class="img-fluid" width="70%" />
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div class="col-6">
                  <div class="d-grid">
                    <button class="preset-btn btn active" data-value="false" onclick="change_box_container('false')">
                      <img src="{{asset('/public/assets/imagescustomizer/img-container-1.svg')}}" alt="img" class="img-fluid"
                        width="70%" />
                    </button>
                  </div>
                </div>
                <div class="col-6">
                  <div class="d-grid">
                    <button class="preset-btn btn" data-value="true" onclick="change_box_container('true')">
                      <img src="{{asset('/public/assets/imagescustomizer/img-container-2.svg')}}" alt="img" class="img-fluid"
                        width="70%" />
                    </button>
                  </div>
                </div>
