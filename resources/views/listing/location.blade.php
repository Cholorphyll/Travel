          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Location <a href="{{route('listing')}}" target="_blank" class="btn btn-info ml-3"><strong>Add New
                  ...
                  <div class="col-md-12 mt-3">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3 mt-4">
                        <button type="submit" class="btn btn-outline-secondary" id="search_location">Search</button>
                      </div>
                    </div>
                    <!-- </form>  -->
                  </div>
