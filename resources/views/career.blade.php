    ...
    <div class="container">
     ...
     <!-- <div class="aboutustext">
        <div class="tnctext d-flex justify-content-center">
          <div class="tnc"><a href="#" class="text-decoration-none"> About Yaan</a></div>
      ...
      <div class="row justify-content-between mt-md-64px">
        ...
        <div class="col-md-12">
          <div class="fs-32 mb-32"><b>TRAVEL MADE -EASY, FUN & MEMORABLE @YAAN
            </b></div>

          <p>At YAAN, we strive to connect individuals with experiences that bring them joy. Whether you're planning a
          ...
          <p class="mt-3">
            The best part of working at YAAN is the freedom to explore your career. You can mould your role and push
          ...
          <p class="mt-3">
            Ready to join us? At YAAN, we hold diversity and inclusivity in high regard. We are committed to providing
          ...
          <p class="mt-3">
            YAAN is proud to be an equal-opportunity employer and committed to offering unwavering support and
            accommodations to all applicants throughout the recruitment process. If, due to a medical condition or
            disability, you require reasonable accommodation, please contact your recruiter or send an email to <a href="mailto:info@yaan.co">info@yaan.co</a>
            with the job requisition number mentioned in your message.

          </p>
          <p class="mt-3">
            At YAAN, we are on a mission to bring people, passions, and places together to create exceptional
            travellers. We aim to empower millions of travellers with the confidence to explore and make a positive
            impact on the world.

          </p>
          <p class="mt-3">
            Working at YAAN is an experience like no other, offering exposure to diverse operations, work methods,
          ...
          <p class="mt-3">
            YAAN is seeking individuals who share their passion for travel and empowering others to explore the world.
          ...
          <p class="mt-3">
            ...
            world, then joining us might be the perfect opportunity for you. At YAAN, we recognize that hiring people
          ...
          <p class="mt-3">
          If you share our enthusiasm for travel and our dedication to diversity and inclusion, we encourage you to join us in revolutionizing the travel industry. Get in touch with us today to discover more. At YAAN, we value a workplace that fosters inclusivity and encourages individuals to showcase their best work. 
          </p>
          <p class="mt-3">
          We acknowledge the significance of diversity and welcome applicants from underrepresented backgrounds in the tech industry. Our dedicated team focuses on engineering and product development, which includes engaging with users, prioritizing tasks, designing, and continuously building and delivering. Our founders' experience at esteemed companies enables us to incorporate the best practices from each of these organizations into YAAN. 
          </p>

          <p class="mt-3">
          Join our team and be part of revolutionizing the travel industry. I couldn't agree more that work-life balance is crucial for a workplace to thrive. It's incredibly refreshing to hear that YAAN is prioritizing the well-being of its employees by implementing regular hours, team lunches, exercise, and quality time with loved ones.
          </p>
          <p class="mt-3">
          As someone who shares a passion for travel, I find it fantastic that YAAN organizes semiannual offsites to explore new places and enjoy the fruits of their labour. YAAN is fully committed to fostering a positive and inclusive work environment that promotes both personal and professional growth. 
