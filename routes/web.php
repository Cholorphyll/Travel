...
//Route::post("filter_availble_hotel", [DataController::class, "filter_availble_hotel"]);  
Route::get("ho", [DataController::class, "filter_availble_hotel"])->name('filter_availble_hotel');
