...
use App\Http\Controllers\InsertDataQueries;
use App\Http\Controllers\InsertHoteldataController;
...
Route::get("/uploadsightimages", [InsertDataQueries::class, "uploadsightimages"])->name('uploadsightimages');
Route::get("/uploadsightimages1", [InsertDataQueries::class, "uploadsightimages1"])->name('uploadsightimages1');

Route::get("/inserthoteldetail", [InsertHoteldataController::class, "inserthoteldetail"])->name('inserthoteldetail');

Route::get("/inserthoteldetail1", [InsertHoteldataController::class, "inserthoteldetail1"])->name('inserthoteldetail1');
